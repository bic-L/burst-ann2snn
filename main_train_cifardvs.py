...
from models.CIFAR10DVS.models.resnet import spiking_resnet18, spiking_resnet34, spiking_resnet50, spiking_resnet101
# import pre_act_model_voxel
import utils
from spikingjelly.clock_driven import functional
from spikingjelly.datasets import cifar10_dvs
from spikingjelly.datasets.dvs128_gesture import DVS128Gesture
from dataset import Cifar10DVS, Dvs128Gesture, AslDVS, NavGestureWalk, NavGestureSit
...
def parse_args():
    ...
    parser.add_argument('--data-path', default='/home/dataset/Cifar10DVS', help='dataset')
...
def load_data(dataset, dataset_dir, distributed, T):
    ...
    # origin_set = DVS128Gesture(root=dataset_dir, data_type='frame', frames_number=T, split_by='number')
...
def main(args):
    ...
    output_dir = os.path.join(args.output_dir, f'{args.dataset}_{args.model}_avg_T{args.T}')
    ...
    if utils.is_main_process():
        wandb.init(project="spikepruning", entity="spikingtransformer", config=args, name=f'{args.dataset}_{args.model}_{args.batch_size}_prtrain', reinit=True)
