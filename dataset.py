...
def AslDVS(root):
    ...
    return SpikingjellyDataset(train_set, True, resolution=(180, 240)), SpikingjellyDataset(test_set, False, resolution=(180, 240))
...
def NavGestureWalk(root, saltnoise):
    ...
    return SpikingjellyDataset(train_set, True, resolution=(240, 304)), SpikingjellyDataset(test_set, False, resolution=(304, 240))
