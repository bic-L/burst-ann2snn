...
def build_data(batch_size=128, cutout=False, workers=4, use_cifar10=False, auto_aug=False, dpath='/home/dataset'):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dpath', default='', type=str, help='root of data path')
    parser.add_argument('--arch', default='res20', type=str, help='dataset name',
                        choices=['CIFARNet', 'VGG16', 'CNN2', 'res20', 'res20m', 'mobv1', 'res9'])
    ...
    train_loader, test_loader = build_data(
        batch_size, cutout=True, workers=num_workers, use_cifar10=use_cifar10, auto_aug=True, dpath=args.dpath)
    best_acc = 0
    best_epoch = 0
    use_bn = args.usebn
